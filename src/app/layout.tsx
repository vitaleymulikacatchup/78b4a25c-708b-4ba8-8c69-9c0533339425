...
export const metadata: Metadata = {
  title: "ShopApp - Smart Shopping for iPhone Users",
  description: "Discover the ultimate iPhone shopping app with smart search, price tracking, and secure checkout. Download free from the App Store.",
  keywords: "iPhone shopping app, mobile shopping, price tracking, secure checkout, iOS app, smartphone shopping",
  metadataBase: new URL("https://shopapp.example.com"),
  alternates: {
    canonical: "https://shopapp.example.com"
  },
  openGraph: {
    title: "ShopApp - Smart Shopping for iPhone Users",
    description: "The ultimate iPhone shopping experience with smart search and price tracking",
    siteName: "ShopApp",
    images: [
      {
        url: "https://images.pexels.com/photos/26100279/pexels-photo-26100279.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "ShopApp interface"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "ShopApp - Smart Shopping for iPhone Users",
    description: "The ultimate iPhone shopping experience with smart search and price tracking",
    images: ["https://images.pexels.com/photos/26100279/pexels-photo-26100279.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
